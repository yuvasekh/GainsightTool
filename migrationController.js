...
exports.CsvFieldsmigration = async (req, res) => {
  try {
    ...
    "indexed": false,
    "isExternalId": false,
    "honorFieldLevelPermission": true,
    "accessible": true,
    "createable": true,
    "updateable": true,
  ...
  label: field.label + '_DELETED'
        ...
        const response = await editFieldsToObject(targetUrl, targetAccessKey, targetObject, updatedFields);
...
async function editFieldsToObject(targetUrl, targetAccessKey, objectName, columnNames) {
  try {
    if (!targetUrl) {
